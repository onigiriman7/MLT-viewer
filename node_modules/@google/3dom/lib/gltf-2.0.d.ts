...
export declare type GLTFElement = Scene | Node | Mesh | Material | Image | Texture | PBRMetallicRoughness | Accessor | Camera | Animation;
export declare type GLTFStructure = PBRMetallicRoughness | Primitive;
